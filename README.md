...
ده بيخلّيكِ تغيّري **الاسم، السعر، السعر القديم، الفئة، والوصف** لأي
منتج أو عرض من جوجل شيت مباشرة — من غير ما تفتحي الكود خالص. **الصور
بتفضل زي ما هي دايمًا جوه `catalog.js`** (زي ما طلبتِ، عشان الصور بتاخد
مساحة وأصعب في النقل).
...
1. اعملي جوجل شيت جديد، وحطي الأعمدة دي بالظبط في أول صف (الأسماء
   ...
   | id | name | category | price | oldPrice | description |
   |----|------|----------|-------|----------|--------------|
